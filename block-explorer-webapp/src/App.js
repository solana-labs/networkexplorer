...
class App extends Component {
    ...
    updateGlobalStats() {
        this.getRemoteState('globalStats', `http:${BLOCK_EXPLORER_API_BASE}/global-stats`);
    }

    updateTxnStats() {
        this.getRemoteState('txnStats', `http:${BLOCK_EXPLORER_API_BASE}/txn-stats`);
    }
    ...
    updateBlocks() {
        ...
        this.getRemoteState('blocks', `http:${BLOCK_EXPLORER_API_BASE}/blk-timeline`, blkFun, 10);
    }
    ...
    updateEntries() {
        ...
        this.getRemoteState('entries', `http:${BLOCK_EXPLORER_API_BASE}/ent-timeline`, entFun, 10);
    }
    ...
    updateTransactions() {
        ...
        this.getRemoteState('transactions', `http:${BLOCK_EXPLORER_API_BASE}/txn-timeline`, txnFun, 10);
    }
    ...
    render() {
        ...
        return (
            <div className="App">
                <BxAppBarThemed handleSearch={self.handleSearch(self)} enabled={this.state.enabled}
                ...
                <Grid container spacing={16} justify="center">
                    <Grid item style={{width:"1460px"}}>
                        <BxDataTableThemed dataType="ent" dataItems={this.state.entries}
                                           handleClickOpen={self.handleClickOpen}/>
                    </Grid>
                </Grid>
                <Grid container spacing={16} justify="center">
